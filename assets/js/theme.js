...
// Toggle between light and dark; always flips the visible theme so that a
// single click changes appearance regardless of whether the current setting
// was "system", "light", or "dark".
